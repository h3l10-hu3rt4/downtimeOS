...
async function enviarPorMeta({ destino, contenido, mediaUrl = null, interactivo = null, plantilla = null }) {
...
export async function enviarWhatsApp({ destinatario, contenido, reporteId = null, eventoFolio = null, interactivo = null, plantilla = null }) {
...
export async function enviarSolicitudAprobacion(solicitud, destinatario = null) {
  ...
  const plantilla = proveedorWhatsApp() === 'meta'
    ...
    : null;
  return enviarWhatsApp({ destinatario, contenido, plantilla });
}
